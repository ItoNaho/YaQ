...
public class ThirdListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListView lvTemple = (ListView) findViewById(R.id.lvn_ichiran);
	...
	private  List<String> createPrefectureList(){
				...
				if(extras != null){
					resultsString = extras.getString("resultString");
				}
				...
				//該当の選手がいないときはTextViewを表示する
				if(name.equals("")){
					TextView tv =  (TextView)findViewById(R.id.tv);
					tv.setText(resultsString+"に該当する選手はいません。\r\n前ページ戻ってもう一度音声認識をお試しください。");
				}
				return  playerList;
	}
